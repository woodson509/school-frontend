        ...
        <>
          ...
          {isSuperAdmin ? (
            ...
            >
              ...
              <Route path="student-progress" element={<TeacherFeedbackPage />} />
              <Route path="feedback" element={<TeacherFeedbackPage />} />

              {/* Communication Routes */}
              <Route path="messages" element={<TeacherMessagesPage />} />
              <Route path="announcements" element={<TeacherAnnouncementsPage />} />
              <Route path="parent-reports" element={<TeacherReportsPage />} />

              {/* Other Routes */}
              <Route path="calendar" element={<TeacherCalendarPage />} />
              <Route path="portfolio" element={<TeacherPortfolioPage />} />
              <Route path="collaboration" element={<TeacherGroupsPage />} />
              <Route path="my-library" element={<TeacherLibraryPage />} />
