        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500">Consultez les événements scolaires</p>
                </div>
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 bg-white rounded-lg shadow-sm p-1">
                        <button
                            onClick={() => setViewMode('month')}
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${viewMode === 'month' ? 'bg-indigo-600 text-white' : 'text-gray-600'
                                }`}
                        >
                            Mois
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${viewMode === 'week' ? 'bg-indigo-600 text-white' : 'text-gray-600'
                                }`}
                        >
                            Semaine
                        </button>
                                ...
                                {days.map((day, index) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`min-h-[80px] p-1 border rounded-lg cursor-pointer transition-all ${!day.isCurrentMonth ? 'bg-gray-50 opacity-50' : 'hover:border-indigo-300'
                                                } ${isSelected ? 'border-indigo-500 ring-2 ring-indigo-200' : 'border-gray-100'}`}
                                        >
                                            <div className={`text-sm font-medium mb-1 w-7 h-7 flex items-center justify-center rounded-full ${isToday ? 'bg-indigo-600 text-white' : 'text-gray-700'
                                                }`}>
                                                {day.date.getDate()}
                                            </div>
